---
title: "Métodos Numéricos - Tarea 2"
...
# Ejercicio 7.10
Revisa en R los c´odigos para resolver sistemas de ecuaciones lineales, esto en un
 archivo tipo Rmd, mismo que deber´as de entregar.
```{r}
...
# Ejercicios a mano 
``` {r}
knitr::include_graphics("Ejercico7-3.png")
```

``` {r}
knitr::include_graphics("Ejercico7-3,2.png")
```

``` {r}
knitr::include_graphics("Ejercico7-3,3.png")
```

``` {r}
knitr::include_graphics("Ejercico7-3,4.png")
```

``` {r}
knitr::include_graphics("Ejercico7-3,5.png")
```

``` {r}
knitr::include_graphics("Ejercico7-4.png")
```

``` {r}
knitr::include_graphics("Ejercico7-4,2.png")
```

``` {r}
knitr::include_graphics("Ejercico7-4,3.png")
```

``` {r}
knitr::include_graphics("Ejercico7-4,4.png")
```

``` {r}
knitr::include_graphics("Ejercico7-5.png")
```

``` {r}
knitr::include_graphics("Ejercico7-5,2.png")
```

``` {r}
knitr::include_graphics("Ejercico7-5,3.png")
```

``` {r}
knitr::include_graphics("Ejercico7-5,4.png")
```

``` {r}
knitr::include_graphics("Ejercico7-6.png")
```

``` {r}
knitr::include_graphics("Ejercico7-6,2.png")
```

``` {r}
knitr::include_graphics("Ejercico7-7.png")
```

``` {r}
knitr::include_graphics("Ejercico7-7,2.png")
```
