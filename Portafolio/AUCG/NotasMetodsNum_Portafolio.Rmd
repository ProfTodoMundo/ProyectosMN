---
title: "Portafolio de Métodos Numéricos"
...
# Nota sobre Metodos Numericos con R
...
## Ejercicios a mano 
``` {r}
knitr::include_graphics("Biseccion1-5-1.png")
```

``` {r}
knitr::include_graphics("Biseccion1-5-1,2.png")
```

``` {r}
knitr::include_graphics("Secante1-5-2.png")
```

``` {r}
knitr::include_graphics("Newton1-5-3.png")
```

``` {r}
knitr::include_graphics("Punto_Fijo1-5-4.png")
```
